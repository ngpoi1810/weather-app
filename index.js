const APP_ID = "0e6f55de9739d052dc15403879f4aae1";
const DEFAULT_VALUE = "--";

const searchInput = document.querySelector("#search-input");
const cityName = document.querySelector(".city-name");
const weatherState = document.querySelector(".weather-text");
...
const handleVoice = (text) => {
  ...
  // thay đổi màu nền [Back, White, Orange,...]
